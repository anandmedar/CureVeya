      ...
      <main id="main">
        <section id="home" className="hero section-shell">
          <div className="hero-copy">
            <p className="eyebrow"><span></span>Bangalore · planned surgical care</p>
