  ...
  return (
    <>
      ...
      <main id="main">
        ...
        <section className="testimonials"><div className="section-shell"><p className="eyebrow light"><span></span>Patient experience</p><div className="quote-grid">{['“The process felt far less overwhelming once I knew whom to call and what to expect next.”', '“Every question was answered calmly, which made it easier to take the first step.”', '“The guidance was clear, respectful and very well coordinated.”'].map((quote, index) => <blockquote key={quote}><span>“</span><p>{quote}</p></blockquote>)}</div></div></section>
