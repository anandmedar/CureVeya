...
export const journey = [
  ...
  ['02', 'Speak with a care guide', 'Coordinator helps you understand the practical next step with clarity.'],
  ['03', 'Meet the right specialist', 'Receive a consultation and a recommendation from a qualified clinician.'],
  ['04', 'Plan with confidence', 'Get support with scheduling, hospital coordination and paperwork.'],
  ['05', 'Recover with continuity', 'Stay connected for practical follow-up guidance after your appointment.'],
]
...
export const faqs = [
  ...
  ['Can I speak to someone before choosing a specialist?', 'Yes. Start with a conversation with Coordinator to explain your concern and understand the process.'],
  ['Can you help with appointment scheduling?', 'Yes. CureVeya can help coordinate consultation preferences and practical appointment details.'],
  ['Is insurance paperwork support available?', 'Support may be available depending on the hospital and insurer. Ask Coordinator about your specific situation.'],
  ['How will I know which speciality is right for me?', 'Your symptoms and history should be assessed by a qualified clinician. We can help you begin with the right consultation.'],
  ['What happens after the consultation?', 'The clinician will advise you. CureVeya can then help with the practical coordination of your next steps.'],
]
